...
def main():
    ...
    dynamodb_tables = [
        os.getenv('DYNAMODB_TABLE_1_TEST'),
        os.getenv('DYNAMODB_TABLE_2_TEST'),
        os.getenv('DYNAMODB_TABLE_3_TEST'),
        os.getenv('DYNAMODB_TABLE_4_TEST'),
        os.getenv('DYNAMODB_TABLE_5_TEST')
    ]
    
    glue_databases = [f"glue_database_{table}_TEST" for table in dynamodb_tables]
